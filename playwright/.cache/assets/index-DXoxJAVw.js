const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RelationshipsTab.story-Ct_rU0ni.js","assets/RelationshipsTab-DA2hJIvm.js"])))=>i.map(i=>d[i]);
...
const _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_story_RelationshipsTabWith400Events = () => __vitePreload(() => import('./RelationshipsTab.story-Ct_rU0ni.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.RelationshipsTabWith400Events);
const _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_story_RelationshipsTabWith50Events = () => __vitePreload(() => import('./RelationshipsTab.story-Ct_rU0ni.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.RelationshipsTabWith50Events);
const _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_story_RelationshipsTabWithEventStore = () => __vitePreload(() => import('./RelationshipsTab.story-Ct_rU0ni.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.RelationshipsTabWithEventStore);
const _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_RelationshipsTab = () => __vitePreload(() => import('./RelationshipsTab-DA2hJIvm.js').then(n => n.k),true              ?[]:void 0).then((mod) => mod.RelationshipsTab);
__pwRegistry.initialize({ _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_story_RelationshipsTabWith400Events,
  _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_story_RelationshipsTabWith50Events,
  _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_story_RelationshipsTabWithEventStore,
  _Users_invisietch_Code_SillyTavern_data_default_user_extensions_BlazeTracker_src_ui_tabs_RelationshipsTab_RelationshipsTab });

export { React as R, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-DXoxJAVw.js.map
